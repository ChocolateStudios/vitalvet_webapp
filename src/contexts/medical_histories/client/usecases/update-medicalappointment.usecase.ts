...
export async function updateMedicalAppointment(petId: string, medicalAppointmentId: string, medicalAppointment: SaveMedicalAppointmentResource): Promise<UsecaseResult<any>> {
    try {
