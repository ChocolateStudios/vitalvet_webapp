...
export async function updateMyProfile(resource: SaveProfileResource, userId?: string): Promise<UsecaseResult<any>> {
    if (!userId) {
...
export async function updateProfile(resource: SaveProfileResource, profileId?: string): Promise<UsecaseResult<any>> {
    if (!profileId) {
